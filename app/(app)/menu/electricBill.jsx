...
const ElectricBill = () => {
  ...
  const handlePayment = () => {
    Alert.alert(
      ...
      `Are you sure you want to pay XAF${customerInfo.total} for your electric bill?`,
      [
        { text: "Cancel", style: "cancel" },
        {
          text: "Pay Now",
          onPress: () => {
            // Navigate to payment success or payment method screen
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Electric payment</Text>
      ...
      <View style={styles.content}>
        <View style={styles.billCard}>
          ...
          <View style={styles.billDetails}>
            ...
            <View style={styles.detailRow}>
              <Text style={styles.detailLabel}>Electric fee</Text>
              <Text style={styles.feeValue}>XA{customerInfo.electricFee}</Text>
            </View>

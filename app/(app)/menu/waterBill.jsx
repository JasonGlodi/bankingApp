...
const WaterBill = () => {
  ...
  const handlePayment = () => {
    Alert.alert(
      ...
      `Are you sure you want to pay XAF${customerInfo.total} for your water bill?`,
      [
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Water payment</Text>
      ...
      <View style={styles.content}>
        <View style={styles.billCard}>
          ...
          <View style={styles.billDetails}>
            ...
            <View style={styles.detailRow}>
              <Text style={styles.detailLabel}>Water fee</Text>
              <Text style={styles.feeValue}>XAF{customerInfo.waterFee}</Text>
            </View>
